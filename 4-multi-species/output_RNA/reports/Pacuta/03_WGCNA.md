...
```
    ...
    ## [61] foreach_1.5.2         pillar_1.11.1         vroom_1.7.1          
    ## [64] circlize_0.4.18       splines_4.5.1         lattice_0.22-9       
    ## [67] survival_3.8-6        bit_4.6.0             annotate_1.88.0      
    ## [70] tidyselect_1.2.1      locfit_1.5-9.12       Biostrings_2.78.0    
    ## [73] knitr_1.51            gridExtra_2.3.1       xfun_0.59            
    ## [76] stringi_1.8.7         yaml_2.3.12           evaluate_1.0.5       
    ## [79] codetools_0.2-20      cli_3.6.6             rpart_4.1.27         
    ## [82] xtable_1.8-8          systemfonts_1.3.2     Rcpp_1.1.1-1.1       
    ## [85] png_0.1-9             XML_3.99-0.23         parallel_4.5.1       
    ## [88] blob_1.3.0            scales_1.4.0          crayon_1.5.3         
    ## [91] GetoptLong_1.1.1      rlang_1.2.0           cowplot_1.2.0        
    ## [94] KEGGREST_1.50.0
