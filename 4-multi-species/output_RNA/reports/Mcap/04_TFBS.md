...
```
    ...
    ## Transcription Factor FOXO3: 8264 genes with putative binding sites.
    ## Gene(s) with most binding sites: Montipora_capitata_HIv3___RNAseq.g30821.t1 Montipora_capitata_HIv3___RNAseq.g30865.t1 Montipora_capitata_HIv3___RNAseq.g30871.t1 Montipora_capitata_HIv3___RNAseq.g33090.t1 ( Best Annotation: NA NA NA NA ) with 6 binding sites.
...
```
    ...
    ## Transcription Factor HSF1: 5901 genes with putative binding sites.
...
```
    ...
    ## Transcription Factor NFE2L2: 4817 genes with putative binding sites.
