...
```
    ...
    ## [10] purrr_1.2.1           readr_2.1.6           tidyr_1.3.1          
    ...
    ##  [75] glue_1.8.0                  Hmisc_5.2-5                
    ##  [77] tools_4.5.1                 data.table_1.18.0          
