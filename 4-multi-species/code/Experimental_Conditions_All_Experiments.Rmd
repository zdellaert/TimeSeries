---
title: "Experimental Conditions During All 4 Experiments"
author: "Zoe Dellaert "
date: "7/9/2025"
output: 
  github_document:
...
```{r}
Pcomp <- read.csv("../../1-Pcom/output_experimental/DMs_Processed.csv")
Mcap <- read.csv("../../2-Mcap/output_experimental/DMs_Processed.csv")
Pacu <- read.csv("../../3-Pacu/output_experimental/DMs_Processed.csv")
...
## Convert datetime to hours from start
...
# Save plot 
ggsave("../output_experimental/pdf_figs/Daily_Measurements_Exp.pdf", daily_tank, width = 10, height = 10, units = c("in"))
ggsave("../output_experimental/Daily_Measurements_Exp.png", daily_tank, width = 10, height = 10, units = c("in"), bg = "white")
```
...
# Save plot 
ggsave("../output_experimental/pdf_figs/Daily_Measurements_Exp_byTreatment.pdf", daily_tank, width = 10, height = 10, units = c("in"))
ggsave("../output_experimental/Daily_Measurements_Exp_byTreatment.png", daily_tank, width = 10, height = 10, units = c("in"), bg = "white")
```
...
```{r}
Pcomp <- read.csv("../../1-Pcom/output_experimental/Experimental_Tank_HoboTempLight_data.csv")
Mcap <- read.csv("../../2-Mcap/output_experimental/Experimental_Tank_HoboTempLight_data.csv")
Pacu <- read.csv("../../3-Pacu/output_experimental/Experimental_Tank_HoboTempLight_data.csv")
...
Temps
ggsave("../output_experimental/pdf_figs/Experimental_Tank_HoboTemp.pdf", plot = last_plot(), width = 8, height = 4)
ggsave("../output_experimental/Experimental_Tank_HoboTemp.png", plot = last_plot(), width = 8, height = 4, bg = "white")
...
Light
ggsave("../output_experimental/pdf_figs/Experimental_Tank_HoboLight.pdf", plot = last_plot(), width = 8, height = 4)
ggsave("../output_experimental/Experimental_Tank_HoboLight.png", plot = last_plot(), width = 8, height = 4, bg = "white")
```

## Plot temp and light by treatment
...
Temps
ggsave("../output_experimental/pdf_figs/Experimental_Tank_HoboTemp_byTreatment.pdf", plot = last_plot(), width = 8, height = 4)
ggsave("../output_experimental/Experimental_Tank_HoboTemp_byTreatment.png", plot = last_plot(), width = 8, height = 4, bg = "white")
...
Light
ggsave("../output_experimental/pdf_figs/Experimental_Tank_HoboLight_byTreatment.pdf", plot = last_plot(), width = 8, height = 4)
ggsave("../output_experimental/Experimental_Tank_HoboLight_byTreatment.png", plot = last_plot(), width = 8, height = 4, bg = "white")
```
