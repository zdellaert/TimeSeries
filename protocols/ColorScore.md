...
https://imagej.nih.gov/ij/download.html. **Alternatively, use Photoshop!**
...
6. Select each of the three color standards and record the mean value given by the histogram.  
  ...
  2. On the histogram window, click through the "RGB" options: "Intensity (unweighted), Intensity (weighted), "R+G+B", "Red", "Green", and stop at "Blue". Record the Mean value in spreadsheet under "Blue.Standard".
...
7. Click the fourth drawing tool option on the main toolbar, freehand selections. Outline the **LIVE coral tissue only**. Do not select any portions of the coral fragment that have a shadow or glare.
